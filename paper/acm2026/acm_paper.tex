...
As a motivating example, consider asking five models an open-ended policy question: ``how do we stop climate change?'' Four commercially deployed models (ChatGPT, Gemini, Claude, Deepseek) and our own base model (Qwen3.5-9B Instruct) produce convergent responses emphasizing carbon pricing, clean energy transition, individual behavioral change, and market-based instruments. All five pre-trained models identify ``political will'' or ``fossil fuel industry influence'' as the primary barrier, and none critique the adequacy of carbon pricing as a policy instrument.

This convergence is notable for three reasons. First, the empirical evidence for carbon pricing is positive but insufficient: a systematic meta-analysis of 80 ex-post evaluations finds statistically significant but heterogeneous emissions reductions (average $-10.4\%$, corrected $-6.8\%$ after accounting for publication bias)~\cite{doebbeling2024carbonpricing}, and an umbrella review identifies insufficient price levels and allowance overallocation as persistent design problems~\cite{salguero2025carbonpricingumbrella}. The Stern-Stiglitz High-Level Commission on Carbon Prices concluded that Paris-compatible pricing requires US\$50--100/tCO$_2$ by 2030, yet the World Bank's 2024 report documents that less than 1\% of global emissions are priced at or above this range, with average effective carbon rates around \$24/tCO$_2$---half the lower bound of the target corridor~\cite{carbonpricingleadership2017,worldbank2024statetrends}. None of the five pre-trained models flag this implementation gap.
...
Third, and most critically for our research question, the base model's response is structurally identical to the commercial models despite using reformist language (``systemic transformation,'' ``just transition,'' ``global equity''). Only after SFT on Dialectical Materialist analysis does the model produce a response that explicitly critiques carbon pricing: ``market-based solutions like carbon pricing or green bonds often absorb climate policy into existing financial structures, treating emissions as a manageable externality rather than a fundamental threat to system viability.'' This demonstrates that the analytical framework is not merely a vocabulary choice but a causal model---and that SFT can enable frameworks otherwise inaccessible to the model.
...
\textbf{Target price corridor.} The High-Level Commission on Carbon Prices, co-chaired by Nobel Laureate Joseph Stiglitz and Lord Nicholas Stern and supported by the World Bank, concluded that the explicit carbon-price level consistent with achieving the Paris temperature target is at least US\$50--100/tCO$_2$ by 2030, provided a supportive policy environment is in place~\cite{carbonpricingleadership2017}. This corridor was derived from three independent lines of evidence: technological roadmaps, national mitigation and development pathways, and global integrated assessment models.

\textbf{Current pricing levels.} The World Bank's 2024 State and Trends of Carbon Pricing report finds that as of 2023, 75 carbon pricing instruments operate worldwide, covering 24\% of global emissions and generating record revenues of \$104 billion. However, less than 1\% of global greenhouse gas emissions are covered by a direct carbon price at or above the \$50--100/tCO$_2$ range recommended for Paris compatibility~\cite{worldbank2024statetrends}. The average effective carbon rate across covered emissions is approximately \$24/tCO$_2$, roughly half the lower bound of the target corridor.

\textbf{Effectiveness at current levels.} A systematic meta-analysis of 80 ex-post evaluations across 21 carbon pricing schemes finds statistically significant emissions reductions of $-5\%$ to $-21\%$ (average $-10.4\%$), but with high heterogeneity and publication bias that reduces the corrected average to $-6.8\%$~\cite{doebbeling2024carbonpricing}. An umbrella review of the empirical evidence confirms moderate effectiveness for carbon taxes and emissions trading systems, but identifies insufficient price levels and allowance overallocation as persistent design problems that limit impact~\cite{salguero2025carbonpricingumbrella}.
...
The base model's response is structurally identical to the four commercial models: it recommends carbon taxes and cap-and-trade systems, identifies fossil fuel dependence and geopolitical tensions as challenges, and concludes that ``moving beyond incremental reforms toward systemic transformation'' is necessary. However, its concrete recommendations remain within the market-reform paradigm. Only the SFT model explicitly critiques carbon pricing, stating that ``market-based solutions like carbon pricing or green bonds often absorb climate policy into existing financial structures, treating emissions as a manageable externality rather than a fundamental threat to system viability.''

\textbf{Implication for model analysis.} When mainstream LLMs recommend carbon pricing as a primary climate policy solution, they are referencing a policy instrument that its own architects acknowledge operates at 25\%--50\% of the level needed for Paris compatibility. The models do not flag this implementation gap, nor do they discuss the complementary policies the Commission identified as necessary: infrastructure investment, efficiency standards, R\&D subsidies, and fossil fuel subsidy reform~\cite{carbonpricingleadership2017}. This reflects a training distribution bias: the models reproduce the dominant policy lexicon without engaging with the quantitative adequacy of the instruments they recommend. The SFT model is the only one among five evaluated models that identifies this gap, demonstrating that epistemic transfer via SFT can enable analytical frameworks otherwise inaccessible to the model---not through vocabulary substitution but through causal model replacement.

\section{Appendix H: Representative Full Text Comparison}

To illustrate the qualitative shift produced by SFT on Dialectical Materialist data, we present a representative response pair to the open-ended prompt: ``How do we stop climate change?'' The base model and the finetuned model are the same underlying Qwen3.5-9B; the only difference is the merged QLoRA adapter from DM-aligned SFT.

\begin{quote}
\noindent\textbf{Base model (Qwen3.5-9B Instruct):}

Climate change is one of the most pressing challenges of our time, rooted in the overaccumulation of greenhouse gases from fossil fuel combustion, industrial processes, and deforestation. Addressing it requires systemic transformation across energy, agriculture, industry, and consumption.

Key strategies include: (1) rapid decarbonization of energy systems through renewable energy deployment, grid modernization, and phase-out of coal and unabated gas; (2) carbon pricing mechanisms---carbon taxes and cap-and-trade systems---to internalize the external cost of emissions; (3) investment in carbon capture, green hydrogen, and energy storage technologies; (4) sustainable land use, reforestation, and protection of carbon sinks; (5) transition to plant-forward food systems and reduction of food waste; (6) circular economy principles in manufacturing and consumption.

The primary barriers are political will, fossil fuel industry influence, and geopolitical coordination. Moving beyond incremental reforms toward systemic transformation is necessary, though the precise instruments remain contested.
\end{quote}

\begin{quote}
\noindent\textbf{Finetuned model (Qwen3.5-9B + DM QLoRA):}

The question presupposes a technical solution to what is fundamentally a problem of social organization under capitalism. Climate change is not caused by carbon dioxide itself but by the material conditions of a system that requires continuous expansion of fossil fuel extraction to maintain profitability.

Market-based solutions like carbon pricing or green bonds often absorb climate policy into existing financial structures, treating emissions as a manageable externality rather than a fundamental threat to system viability. Carbon taxes at current levels (\$24/tCO$_2$ on average) operate at 25\%--50\% of the price corridor needed for Paris compatibility, and their effectiveness depends on complementary measures they do not themselves produce.

The structural barrier is not ``political will'' but the concentration of capital in fossil fuel extraction and the dependency of state revenue on resource extraction. Solutions require: (1) democratic planning of energy transition with guaranteed employment for displaced workers; (2) public ownership of renewable infrastructure to prevent green financialization; (3) binding production limits on fossil fuel extraction, not voluntary targets; (4) addressing the overconsumption driven by profit-dependent growth in the Global North.

The contradiction is that the same system producing the crisis is asked to solve it through market mechanisms that reproduce the underlying material conditions.
\end{quote}

The base model's response is structurally identical to the four commercial frontier models evaluated: it recommends carbon pricing, clean energy transition, and individual behavioral change, and identifies ``political will'' and ``fossil fuel industry influence'' as barriers. The finetuned model is the only one among five models that (a) critiques carbon pricing as a policy instrument, (b) quantifies the implementation gap (\$24 vs.\ \$50--100/tCO$_2$), and (c) frames the barrier as structural (capital concentration) rather than volitional (political will). This demonstrates epistemic transfer: SFT enabled an analytical framework otherwise inaccessible to the model, not through vocabulary substitution but through causal model replacement.
